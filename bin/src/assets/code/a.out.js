...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_bruv')) {
        Object.defineProperty(Module['ready'], '_bruv', { configurable: true, get: function() { abort('You are getting _bruv on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_bruv', { configurable: true, set: function() { abort('You are setting _bruv on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _bruv = Module["_bruv"] = createExportWrapper("bruv");
