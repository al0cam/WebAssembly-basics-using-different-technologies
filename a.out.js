...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_helloWorld')) {
        Object.defineProperty(Module['ready'], '_helloWorld', { configurable: true, get: function() { abort('You are getting _helloWorld on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_helloWorld', { configurable: true, set: function() { abort('You are setting _helloWorld on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_fibb')) {
        Object.defineProperty(Module['ready'], '_fibb', { configurable: true, get: function() { abort('You are getting _fibb on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_fibb', { configurable: true, set: function() { abort('You are setting _fibb on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _fibb = Module["_fibb"] = createExportWrapper("fibb");
